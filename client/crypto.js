 ...
 * - Salt:
 *   - Random value with 16 random bytes generated fresh for every snapshot (intended process but not what we will do right now)
...
function deriveKey(secret) {
    const salt = 'stash-zero-knowledge-salt'            // To be changed later to something that changes per payload
